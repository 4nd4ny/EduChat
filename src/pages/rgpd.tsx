    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "8. Monitoraggio della piattaforma: l'amministrazione riceve copia dei messaggi di servizio e, per ogni richiesta di codice di verifica, un avviso con l'indirizzo interessato e l'ora — mai il codice, che resta il Suo unico giustificativo d'identità.",
      ...
      },
      {
        ...
        body: [
          ...
          "I Suoi tutor pubblicati non vengono MAI eliminati: una volta nel catalogo appartengono al dominio pubblico di EduChat e i loro contatori servono alle fatture degli istituti. Li DEPUBBLICA — escono dal catalogo e può ripubblicarli. L'archiviazione definitiva si chiede all'amministrazione.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Chinesische Modelle (DeepSeek, Qwen, Kimi, GLM, MiniMax) tragen in der Oberfläche eine ROTE « WRNG »-Flagge: Ihr Anbieter sitzt ausserhalb der EU/des EWR, ohne anerkannten Übermittlungsrahmen — Eingaben können gespeichert, zum Training weiterverwendet und lokalen Behörden zugänglich gemacht werden. Sie bleiben mit IHREM Schlüssel verfügbar, aus einem bestätigten Konto und ausserhalb eines Schulnetzes, für nicht personenbezogene Inhalte — nie für identifizierbare Schülerarbeiten. Ohne Konto werden sie gar nicht angeboten: Ein von einer anonymen Person eingefügter Schlüssel öffnet sie nicht mehr.",
