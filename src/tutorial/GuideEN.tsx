  ...
  return (
    <>
      ...
      <Section id="enseignants" title="Teachers — the class">
        ...
        <ul className="list-inside list-disc space-y-1">
          <li><b>Open the room</b>: the room password unlocks the platform's key for the duration you choose. Be aware that this unlock is not restricted to your network: while it lasts, that key also answers any verified account, wherever it is calling from — which is why a duration is asked for, and why you can close it before time. No student needs an account or a key.</li>
