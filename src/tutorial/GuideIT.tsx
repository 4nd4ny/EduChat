  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm">
        <b>E per tutti: « I miei dati »</b> — <Link href="/compte?visite=1" className="underline">la pagina che mostra ciò che il server conserva di te — visita guidata</Link>.
      </p>
