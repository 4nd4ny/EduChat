  ...
  return (
    <>
      ...
      <Section id="acces" title="Welcher KI-Anbieter, für wen">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="align-top">
              ...
              <tr className="border-b border-white/5"><td className="py-1.5 pr-2"><b>Aus einem Schulnetz</b></td><td className="pr-2">Die konformen Anbieter, die die Schule zulässt, auf ihrem Schlüssel.</td><td>Jene der Schule — ausser Ihr eigener Schlüssel ist bereits mit Ihrem Konto verknüpft: dann alle.</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <p><b>Im Netz einer Schule.</b> Dort steht die Schule für ihre Schüler ein, und ihre Regel gilt für alle, mit oder ohne Konto: Angeboten werden nur die konformen Anbieter, und der Schlüssel der Schule bezahlt die übrigen nie. Eine Ausnahme, eine einzige: Ein Konto, dessen eigener Schlüssel <b>vor dem Kommen verknüpft</b> wurde, erhält die ganze Liste zurück — was eine erwachsene Person selbst bezahlt, geht die Schule nichts an. Ein Schlüssel, der vor Ort einfach ins Feld getippt wird, hebt nichts auf: Sonst würde ein in einem Forum gefundener Schlüssel im Klassenzimmer wieder öffnen, was die Schule ausgeschlossen hat.</p>
      ...
      <Section id="enseignants" title="Lehrpersonen — die Klasse">
        ...
        <ul className="list-inside list-disc space-y-1">
          ...
          <li><b>Einen Tutor bereitstellen</b>: Der gewählte Tutor erscheint bei jedem Schüler im Raum vorausgewählt, mit oder ohne Websuche. Sie können auch die Anbieter der Lektion einschränken; alle abzuwählen ist eine legitime Wahl, und sie schliesst — der Schlüssel der Schule bedient dann nichts mehr. Der Filter gilt nur für diesen Schlüssel: Wer den eigenen mitbringt, hängt nicht davon ab. Im Perimeter der Schule bleibt er dennoch: In diesem Netz öffnet ihm sein Schlüssel nur die konformen Anbieter, sofern er nicht bereits mit seinem Konto verknüpft ist.</li>
      ...
      <Section id="etablissement" title="Schulen — die Schule bei sich">
        ...
        <p><b>Das Guthaben im Voraus.</b> Die Schule zahlt einen Betrag ein; jeder Aufruf über den Schlüssel der Plattform wird <b>zum exakten, vom Anbieter veröffentlichten Preis</b> davon abgezogen — Anthropic, OpenAI, Mistral — ohne einen Rappen Aufschlag. Das ist der springende Punkt, und er ist überprüfbar: Öffnen Sie deren Tarif, rechnen Sie nach, und Sie finden unsere Zahl. Ein Dienst, der zwischen einer Schule und den Anbietern steht, hat nichts Besseres zu bieten als eine Abrechnung, die die Schule selbst nachrechnen kann; eine im Tokenpreis aufgelöste Marge lässt sich dagegen schlecht prüfen und gut verdächtigen. Geprüft wird vor dem Aufruf: Eine bereits begonnene Antwort wird bezahlt, die Überschreitung ist also durch eine Antwort begrenzt. Der Bildschirm zeigt den Saldo, die Ausgaben der letzten dreissig Tage, die geschätzte Reichweite in Tagen, die vorgeschlagene Aufladung und den datierten Verlauf der Bewegungen — Aufladung, Verbrauch, Korrektur. <b>Heute wird noch nichts verrechnet</b>: Es ist kein Zahlungsmittel an die Website angebunden, und eine Aufladung wird vereinbart, indem Sie uns schreiben. In der Zwischenzeit kann jede und jeder den eigenen KI-Schlüssel mitbringen.</p>
