  ...
  return (
    <>
      ...
      <Section id="enseignants" title="Enseignants — la classe">
        ...
        <ul className="list-inside list-disc space-y-1">
          <li><b>Ouvrir la salle</b> : le mot de passe de salle déverrouille la clé de la plateforme pour la durée que vous choisissez. <b>Sachez que ce déverrouillage n'est pas borné à votre réseau</b> : tant qu'il dure, cette clé répond aussi à tout compte vérifié, d'où qu'il appelle — c'est pourquoi une durée vous est demandée, et pourquoi vous pouvez refermer avant l'heure. Dans la salle, l'appel est reconnu par l'IP du réseau et décompté à l'école ; au-dehors, il ne l'est pas. Aucun élève n'a de compte ni de clé à saisir.</li>
