  ...
  return (
    <>
      ...
      <p className="mt-3 text-sm">
        <b>Et pour tout le monde : « Mes données »</b> — <Link href="/compte?visite=1" className="underline">la page qui montre ce que le serveur conserve de vous — visite guidée</Link>.
      </p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="align-top">
              <tr className="border-b border-white/5"><td className="py-1.5 pr-2">Conversations, clé API personnelle, favoris, notes données, pièces jointes</td><td className="pr-2"><b>Votre navigateur</b></td><td>Jamais sur le serveur (les pièces jointes ne sont que relayées au fournisseur). La clé personnelle est conservée dans CE navigateur pour ne pas la retaper — voyez la page Confidentialité. Deux exceptions : la sauvegarde du profil pour les comptes, et la clé mémorisée sur le serveur, sur demande.</td></tr>
